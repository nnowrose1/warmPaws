...
const Vet = ({vet, index}) => {
    return (
        <div data-aos="fade-zoom-in"
                    data-aos-delay={index * 200} className="card transition-transform transform hover:-translate-y-2 bg-base-100 shadow-lg hover:shadow-xl rounded-2xl overflow-hidden p-4">
      <img
        src={vet.image}
        alt={vet.name}
